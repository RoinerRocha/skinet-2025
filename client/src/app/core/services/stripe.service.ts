...
export class StripeService {
  ...
  private addessElement?: StripeAddressElement;
  ...
  async createPaymentElement() {
    if (!this.paymentElement) {
      ...
      if (elements) {
        ...
        throw new Error('Elemets instance has not been initialized');
      }
    }
  ...
  async createAddressElement() {
    if (!this.addessElement) {
      ...
      if (elements) {
        ...
        this.addessElement = elements.create('address', options);
      }
    }
    return this.addessElement;
  }
